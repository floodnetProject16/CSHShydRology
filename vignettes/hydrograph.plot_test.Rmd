...
result1 <- hydrograph.plot(flows = daily_flows, winter.shading = FALSE)
result2 <- hydrograph.plot(flows = daily_flows, winter.shading = TRUE)
```
...
result3 <- hydrograph.plot(flows = daily_flows, winter.shading = TRUE,
prd = myprd)
```
...
result4 <- hydrograph.plot(flows = daily_flows, precip = precip, winter.shading = TRUE,
prd = myprd)
```
...
```{r}
result5 <- hydrograph.plot(flows = daily_flows, precip = precip, winter.shading = TRUE,
...
result6 <- hydrograph.plot(flows = daily_flows, precip = precip,
...
result7 <- hydrograph.plot(flows = daily_flows, precip = precip,
...
```{r}
result8 <- hydrograph.plot(flows = daily_flows, precip = precip,
prd = myprd, leg.pos='right') # change legend to the right side
result9 <- hydrograph.plot(flows = daily_flows, precip = precip,
prd = myprd, leg.box=TRUE) # add legend fill and outline
result10 <- hydrograph.plot(flows = daily_flows, precip = precip,
